...
- About team cards (Leadership / Key Management / Advisors, 3 identical grids) use image banners at `h-72 sm:h-44 md:h-52`, the taller mobile frame keeps portraits readable in the single-column layout. Keep the three grids in sync.
