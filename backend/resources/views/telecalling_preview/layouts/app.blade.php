    ...
    <div class="app-shell" id="appShell">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-logo">
                <a href="{{ route('telecalling-preview.dashboard') }}"><img src="{{ asset('logo.png') }}" alt="Manikstu Agro" /></a>
            </div>
            ...
            <nav class="sidebar-nav">
                ...
                @foreach($nav as [$key, $label, $icon])
                    <a href="{{ route('telecalling-preview.' . $key) }}" class="nav-item {{ request()->routeIs('telecalling-preview.' . $key) ? 'active' : '' }}">
                    ...
                    <div class="bell-wrap">
                        ...
                        <div class="notif-panel" id="notifPanel" hidden>
                            <div class="notif-head">
                                ...
                                @if($tcUnread > 0)
                                    <form method="POST" action="{{ route('telecalling-preview.notifications.read') }}" style="margin:0;">
                                        @csrf
                                        @method('PUT')
