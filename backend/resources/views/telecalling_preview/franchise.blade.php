        ...
        <table class="tc-table">
            ...
            <tbody>
                @forelse($leads as $l)
                    ...
                    <tr>
                        <td><a href="{{ route('telecalling-preview.franchise.show', $l['id']) }}" class="lead-id">{{ $l['id'] }}</a></td>
                        <td>{{ $l['name'] }}</td>
                        <td>{{ $l['location'] }}</td>
                        <td>{{ $l['investment'] }}</td>
                        ...
                        <td>{{ $l['date'] }}</td>
                        <td>
                            <a href="{{ route('telecalling-preview.franchise.show', $l['id']) }}" class="eye-btn" title="View">
