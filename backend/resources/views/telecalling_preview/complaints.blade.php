        ...
        <table class="tc-table">
            ...
            <tbody>
                @forelse($complaints as $c)
                    ...
                    @endphp
                    <tr>
                        <td><a href="{{ route('telecalling-preview.complaint.show', $c['id']) }}" class="cmp-id">{{ $c['id'] }}</a></td>
                        <td>{{ $c['farmer'] }}</td>
                        <td><a href="{{ route('telecalling-preview.order.show', $c['order']) }}" class="ord-id">{{ $c['order'] }}</a></td>
                        <td>{{ $c['issue'] }}</td>
                        ...
                        <td>
                            <a href="{{ route('telecalling-preview.complaint.show', $c['id']) }}" class="eye-btn" title="View">
