...
<a href="{{ route('telecalling-preview.complaints') }}" class="back-btn">
...
<div class="cd-grid2">
    ...
    <div class="card">
        ...
        <div class="pad">
            <div class="kv"><span class="k">Order ID</span><span class="sep">:</span><a href="{{ route('telecalling-preview.order.show', $complaint['order']) }}" class="v" style="color:#C4952A;">{{ $complaint['order'] }}</a></div>
