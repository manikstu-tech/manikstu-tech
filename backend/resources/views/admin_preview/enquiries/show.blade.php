...
@section('content')
<div class="page-header"><div><h1 class="page-title">Enquiry from {{ $enquiry->name }}</h1><p class="page-subtitle">{{ $enquiry->created_at->format('M d, Y \a\t g:i A') }}</p></div><a href="{{ route('admin-preview.enquiries.index') }}" class="btn btn-secondary">Back</a></div>
