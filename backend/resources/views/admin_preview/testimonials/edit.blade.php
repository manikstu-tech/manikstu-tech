...
<form method="POST" action="{{ route('admin-preview.testimonials.update', $testimonial) }}">
    @csrf @method('PUT')
    <div class="form-card">
    ...
    <div class="form-actions"><a href="{{ route('admin-preview.testimonials.index') }}" class="btn btn-secondary">Cancel</a><button type="submit" class="btn btn-primary">Update</button></div>
</form>
