...
<div class="page-header">
    ...
    <a href="{{ route('admin-preview.testimonials.create') }}" class="btn btn-primary">
...
<div class="ts-card">
    <div class="ts-scroll">
        <table class="ts-table">
            <thead>
                <tr>
                    <th><a href="{{ $sortUrl('name') }}" class="th-sort {{ $curSort === 'name' ? 'active' : '' }}">Name @include('admin_preview.testimonials._sorticon', ['col' => 'name'])</a></th>
                    <th>Location</th>
                    <th><a href="{{ $sortUrl('rating') }}" class="th-sort {{ $curSort === 'rating' ? 'active' : '' }}">Rating @include('admin_preview.testimonials._sorticon', ['col' => 'rating'])</a></th>
                    <th><a href="{{ $sortUrl('status') }}" class="th-sort {{ $curSort === 'status' ? 'active' : '' }}">Status @include('admin_preview.testimonials._sorticon', ['col' => 'status'])</a></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="ts-actions">
                                <a href="{{ route('admin-preview.testimonials.edit', $t) }}" class="act-btn" title="Edit">
                                ...
                                <div class="ts-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="{{ route('admin-preview.testimonials.edit', $t) }}" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="{{ route('admin-preview.testimonials.destroy', $t) }}" onsubmit="return confirm('Delete testimonial by {{ addslashes($t->name) }}?')">
                                            @csrf @method('DELETE')
