...
<div class="page-header">
    ...
    <div class="header-actions">
        <a href="{{ route('admin-preview.orders.index') }}" class="btn btn-light">← Back</a>
        <a href="{{ route('admin-preview.orders.edit', $order) }}" class="btn btn-primary">Update Status</a>
    </div>
</div>
                                    ...
                                    <td>
                                        <div class="item-cell">
                                            ...
                                            <div>
                                                <div class="item-name">
                                                    @if($item->product)
                                                        <a href="{{ route('admin-preview.products.show', $item->product) }}">{{ $item->product_name ?: $item->product->name }}</a>
                                                    @else
