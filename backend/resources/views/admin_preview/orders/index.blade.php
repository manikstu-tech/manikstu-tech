...
<div class="ord-header">
    ...
    <a href="{{ route('admin-preview.orders.create') }}" class="btn-add">
    ...
    <table class="ord-table">
        ...
        <tbody>
            @foreach($rows as $r)
                ...
                <tr>
                    <td>@if($oid)<a href="{{ route('admin-preview.orders.show', $oid) }}" class="ord-num ord-num-link">{{ $r['num'] }}</a>@else<span class="ord-num">{{ $r['num'] }}</span>@endif</td>
                    <td>
                        <div class="cust">
                    ...
                    <td>
                        <div class="ord-actions">
                            <a href="{{ $oid ? route('admin-preview.orders.show', $oid) : '#' }}" title="View details"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg></a>
                            @if($oid)<a href="{{ route('admin-preview.orders.edit', $oid) }}" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></a>@endif
                        </div>
                    </td>
                </tr>
            @endforeach
