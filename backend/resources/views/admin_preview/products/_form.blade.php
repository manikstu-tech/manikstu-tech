...
<div class="page-header">
    ...
    <a href="{{ route('admin-preview.products.index') }}" class="btn btn-light">← Back to Products</a>
</div>
...
<form method="POST" action="{{ $isEdit ? route('admin-preview.products.update', $product) : route('admin-preview.products.store') }}" enctype="multipart/form-data" id="productForm">
    @csrf
