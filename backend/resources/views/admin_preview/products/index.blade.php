...
<div class="prod-toolbar">
    ...
    <a href="{{ route('admin-preview.products.create') }}" class="btn-add">
                ...
                <tr>
                    <td>
                        <div style="display:flex;align-items:center;gap:12px;">
                            ...
                            @endif
                            <div>
                                <a href="{{ route('admin-preview.products.show', $product) }}" class="prod-name-link"><strong>{{ $product->name }}</strong></a>
                    ...
                    <td>
                        <form method="POST" action="{{ route('admin-preview.products.togglePublish', $product) }}" style="display:inline;">
                            @csrf @method('PUT')
                    ...
                    <td>
                        <div class="row-actions" style="justify-content:flex-end;">
                            <a href="{{ route('admin-preview.products.show', $product) }}" class="act-view" title="View details"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg></a>
                            <a href="{{ route('admin-preview.products.edit', $product) }}" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></a>
                            <button type="button" class="btn-delete" onclick="openModal('deleteModal','{{ route('admin-preview.products.destroy', $product) }}')" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
                        </div>
                    </td>
                </tr>
            @empty
                <tr class="empty-row">
                    <td colspan="5" style="padding:0;">
                        <div class="prod-empty">
                            ...
                            <a href="{{ route('admin-preview.products.create') }}" class="empty-btn">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
                                Add Product
                            </a>
                        </div>
