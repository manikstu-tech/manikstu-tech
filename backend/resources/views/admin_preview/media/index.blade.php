...
<form method="POST" action="{{ route('admin-preview.media.upload') }}" enctype="multipart/form-data" id="uploadForm">
    @csrf
            ...
            <div class="media-info">
                ...
                <div class="media-menu">
                    ...
                    <div class="kebab-menu">
                        ...
                        <form method="POST" action="{{ route('admin-preview.media.destroy', $m) }}" onsubmit="return confirm('Delete this file?')">
                            @csrf @method('DELETE')
