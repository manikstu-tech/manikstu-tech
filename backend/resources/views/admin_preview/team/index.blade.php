...
<div class="page-header">
    ...
    <a href="{{ route('admin-preview.team.create') }}" class="btn btn-primary">
...
<div class="tm-card">
    <div class="tm-scroll">
        <table class="tm-table">
            <thead>
                <tr>
                    <th><a href="{{ $sortUrl('name') }}" class="th-sort {{ $curSort === 'name' ? 'active' : '' }}">Name @include('admin_preview.team._sorticon', ['col' => 'name'])</a></th>
                    <th><a href="{{ $sortUrl('role') }}" class="th-sort {{ $curSort === 'role' ? 'active' : '' }}">Role @include('admin_preview.team._sorticon', ['col' => 'role'])</a></th>
                    <th><a href="{{ $sortUrl('status') }}" class="th-sort {{ $curSort === 'status' ? 'active' : '' }}">Status @include('admin_preview.team._sorticon', ['col' => 'status'])</a></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="tm-actions">
                                <a href="{{ route('admin-preview.team.edit', $m) }}" class="act-btn" title="Edit">
                                ...
                                <div class="tm-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="{{ route('admin-preview.team.edit', $m) }}" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="{{ route('admin-preview.team.destroy', $m) }}" onsubmit="return confirm('Delete {{ addslashes($m->name) }}?')">
                                            @csrf @method('DELETE')
