...
<div class="page-header">
    ...
    <a href="{{ route('admin-preview.partners.create') }}" class="btn btn-primary">
...
<div class="pt-card">
    <div class="pt-scroll">
        <table class="pt-table">
            <thead>
                <tr>
                    <th><a href="{{ $sortUrl('name') }}" class="th-sort {{ $curSort === 'name' ? 'active' : '' }}">Name @include('admin_preview.partners._sorticon', ['col' => 'name'])</a></th>
                    <th><a href="{{ $sortUrl('category') }}" class="th-sort {{ $curSort === 'category' ? 'active' : '' }}">Category @include('admin_preview.partners._sorticon', ['col' => 'category'])</a></th>
                    <th>Website</th>
                    <th><a href="{{ $sortUrl('status') }}" class="th-sort {{ $curSort === 'status' ? 'active' : '' }}">Status @include('admin_preview.partners._sorticon', ['col' => 'status'])</a></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="pt-actions">
                                <a href="{{ route('admin-preview.partners.edit', $p) }}" class="act-btn" title="Edit">
                                ...
                                <div class="pt-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="{{ route('admin-preview.partners.edit', $p) }}" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="{{ route('admin-preview.partners.destroy', $p) }}" onsubmit="return confirm('Delete {{ addslashes($p->name) }}?')">
                                            @csrf @method('DELETE')
