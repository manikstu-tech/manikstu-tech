        ...
        try {
            foreach (\App\Models\Enquiry::latest()->take(6)->get() as $e) {
                $notifItems->push([
                    ...
                    'url' => route('admin-preview.enquiries.index'),
                ]);
            }
        } catch (\Throwable $ex) {}
        try {
            foreach (\App\Models\Order::latest()->take(6)->get() as $o) {
                $notifItems->push([
                    ...
                    'url' => route('admin-preview.orders.index'),
                ]);
            }
        } catch (\Throwable $ex) {}
    ...
    <div class="app-shell" id="appShell">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-logo">
                <a href="{{ route('admin-preview.dashboard') }}">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('admin-preview.dashboard') }}" class="nav-item {{ request()->routeIs('admin-preview.dashboard') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                    Dashboard
                </a>

                <p class="nav-group-label">Catalog</p>
                <a href="{{ route('admin-preview.products.index') }}" class="nav-item {{ request()->routeIs('admin-preview.products*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin-preview.categories.index') }}" class="nav-item {{ request()->routeIs('admin-preview.categories*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin-preview.orders.index') }}" class="nav-item {{ request()->routeIs('admin-preview.orders*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin-preview.customers.index') }}" class="nav-item {{ request()->routeIs('admin-preview.customers*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    Customers
                </a>
                <a href="{{ route('admin-preview.enquiries.index') }}" class="nav-item {{ request()->routeIs('admin-preview.enquiries*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                    Enquiries
                </a>

                <p class="nav-group-label">Content</p>
                <a href="{{ route('admin-preview.blog.index') }}" class="nav-item {{ request()->routeIs('admin-preview.blog*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                    Blog Posts
                </a>
                <a href="{{ route('admin-preview.press.index') }}" class="nav-item {{ request()->routeIs('admin-preview.press*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin-preview.media.index') }}" class="nav-item {{ request()->routeIs('admin-preview.media*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin-preview.team.index') }}" class="nav-item {{ request()->routeIs('admin-preview.team*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Team
                </a>
                <a href="{{ route('admin-preview.careers.index') }}" class="nav-item {{ request()->routeIs('admin-preview.careers*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin-preview.training.index') }}" class="nav-item {{ request()->routeIs('admin-preview.training*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                    Training
                </a>
                <a href="{{ route('admin-preview.testimonials.index') }}" class="nav-item {{ request()->routeIs('admin-preview.testimonials*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                    Testimonials
                </a>
                <a href="{{ route('admin-preview.partners.index') }}" class="nav-item {{ request()->routeIs('admin-preview.partners*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Partners
                </a>

                <p class="nav-group-label">System</p>
                <a href="{{ route('admin-preview.settings.edit') }}" class="nav-item {{ request()->routeIs('admin-preview.settings*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin-preview.users.index') }}" class="nav-item {{ request()->routeIs('admin-preview.users*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Users
                </a>
            </nav>
            ...
            <div class="sidebar-user">
                ...
                <form method="POST" action="{{ route('admin-preview.logout') }}">
                    @csrf
                ...
                <div class="topbar-right">
                    <div class="topbar-bell-wrap" id="bellWrap">
                        ...
                        <div class="topbar-bell-menu" id="bellMenu">
                            ...
                            <a href="{{ route('admin-preview.enquiries.index') }}" class="bell-menu-foot">View all enquiries</a>
                        </div>
                    </div>
                    <div class="topbar-user-wrap" id="userWrap">
                        ...
                        <div class="topbar-user-menu" id="userMenu">
                            ...
                            <a href="{{ route('admin-preview.settings.edit') }}" class="user-menu-item">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>
                                Settings
                            </a>
                            <form method="POST" action="{{ route('admin-preview.logout') }}">
