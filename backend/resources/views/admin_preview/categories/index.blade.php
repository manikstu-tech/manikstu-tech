...
<div class="cat-toolbar">
    ...
    <a href="{{ route('admin-preview.categories.create') }}" class="btn-add">
                ...
                <tr>
                    ...
                    <td>
                        <div class="row-actions" style="justify-content:flex-end;">
                            <a href="{{ route('admin-preview.categories.edit', $category) }}" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></a>
                            <button type="button" class="btn-delete" onclick="openModal('deleteModal','{{ route('admin-preview.categories.destroy', $category) }}')" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
                        </div>
                    </td>
                </tr>
            @empty
                <tr class="empty-row">
                    <td colspan="5" style="padding:0;">
                        <div class="cat-empty">
                            ...
                            <a href="{{ route('admin-preview.categories.create') }}" class="empty-btn">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
                                Add Category
                            </a>
                        </div>
