...
<div class="page-header">
    ...
    <a href="{{ route('admin-preview.careers.create') }}" class="btn btn-primary">
...
<div class="job-card">
    <div class="job-scroll">
        <table class="job-table">
            <thead>
                <tr>
                    <th><a href="{{ $sortUrl('title') }}" class="th-sort {{ $curSort === 'title' ? 'active' : '' }}">Title @include('admin_preview.careers._sorticon', ['col' => 'title'])</a></th>
                    <th><a href="{{ $sortUrl('department') }}" class="th-sort {{ $curSort === 'department' ? 'active' : '' }}">Department @include('admin_preview.careers._sorticon', ['col' => 'department'])</a></th>
                    <th>Location</th>
                    <th>Type</th>
                    <th><a href="{{ $sortUrl('status') }}" class="th-sort {{ $curSort === 'status' ? 'active' : '' }}">Status @include('admin_preview.careers._sorticon', ['col' => 'status'])</a></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="job-actions">
                                <a href="{{ route('admin-preview.careers.edit', $job) }}" class="act-btn" title="Edit">
                                ...
                                <div class="job-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="{{ route('admin-preview.careers.edit', $job) }}" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="{{ route('admin-preview.careers.destroy', $job) }}" onsubmit="return confirm('Delete {{ addslashes($job->title) }}?')">
                                            @csrf @method('DELETE')
