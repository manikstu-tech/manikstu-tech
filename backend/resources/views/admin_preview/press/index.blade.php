...
<div class="pr-header">
    ...
    <a href="{{ route('admin-preview.press.create') }}" class="btn-add">
                ...
                <tr>
                    ...
                    <td>
                        <div class="pr-actions">
                            @if($r['id'])
                                <a href="{{ route('admin-preview.press.edit', $r['id']) }}" title="Options"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg></a>
                            @else
