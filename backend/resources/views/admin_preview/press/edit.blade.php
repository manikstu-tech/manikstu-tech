...
<div class="page-header">
    <h1 class="page-title">Edit Release</h1>
</div>
...
<form method="POST" action="{{ route('admin-preview.press.update', $release) }}">
    @csrf
    @method('PUT')
        ...
        <div class="form-side">
            <div class="form-card">
                ...
                <div style="padding:18px;">
                    <x-admin.form-field label="Status" name="is_published" type="toggle" :value="$release->is_published" />
