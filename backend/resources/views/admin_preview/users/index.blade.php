...
<div class="page-header">
    ...
    <a href="{{ route('admin-preview.users.create') }}" class="btn btn-primary">
...
<div class="us-card">
    <div class="us-scroll">
        <table class="us-table">
            <thead>
                <tr>
                    <th><a href="{{ $sortUrl('name') }}" class="th-sort {{ $curSort === 'name' ? 'active' : '' }}">Name @include('admin_preview.users._sorticon', ['col' => 'name'])</a></th>
                    <th>Email</th>
                    <th><a href="{{ $sortUrl('role') }}" class="th-sort {{ $curSort === 'role' ? 'active' : '' }}">Role @include('admin_preview.users._sorticon', ['col' => 'role'])</a></th>
                    <th><a href="{{ $sortUrl('status') }}" class="th-sort {{ $curSort === 'status' ? 'active' : '' }}">Status @include('admin_preview.users._sorticon', ['col' => 'status'])</a></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="us-actions">
                                <a href="{{ route('admin-preview.users.edit', $u) }}" class="act-btn" title="Edit">
                                ...
                                <div class="us-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="{{ route('admin-preview.users.edit', $u) }}" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        @if($u->id !== Auth::id())
                                            <form method="POST" action="{{ route('admin-preview.users.destroy', $u) }}" onsubmit="return confirm('Delete {{ addslashes($u->name) }}?')">
                                                @csrf @method('DELETE')
