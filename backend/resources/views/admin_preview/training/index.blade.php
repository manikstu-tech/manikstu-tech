...
<div class="page-header">
    ...
    <a href="{{ route('admin-preview.training.create') }}" class="btn btn-primary">
...
<div class="tr-card">
    <div class="tr-scroll">
        <table class="tr-table">
            <thead>
                <tr>
                    <th><a href="{{ $sortUrl('title') }}" class="th-sort {{ $curSort === 'title' ? 'active' : '' }}">Title @include('admin_preview.training._sorticon', ['col' => 'title'])</a></th>
                    <th><a href="{{ $sortUrl('order') }}" class="th-sort {{ $curSort === 'order' ? 'active' : '' }}">Order @include('admin_preview.training._sorticon', ['col' => 'order'])</a></th>
                    <th><a href="{{ $sortUrl('status') }}" class="th-sort {{ $curSort === 'status' ? 'active' : '' }}">Status @include('admin_preview.training._sorticon', ['col' => 'status'])</a></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="tr-actions">
                                <a href="{{ route('admin-preview.training.edit', $p) }}" class="act-btn" title="Edit">
                                ...
                                <div class="tr-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="{{ route('admin-preview.training.edit', $p) }}" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="{{ route('admin-preview.training.destroy', $p) }}" onsubmit="return confirm('Delete {{ addslashes($p->title) }}?')">
                                            @csrf @method('DELETE')
