...
<div class="dash-header">
    ...
    <form method="GET" action="{{ route('admin-preview.dashboard') }}">
...
<div class="content-grid">
    <div class="card">
        <div class="card-head">
            ...
            <a href="{{ route('admin-preview.enquiries.index') }}" class="view-all">View all <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></a>
        </div>
    ...
    <div class="card">
        ...
        <div class="qa-list">
            <a href="{{ route('admin-preview.products.create') }}" class="qa-item">
            ...
            <a href="{{ route('admin-preview.blog.create') }}" class="qa-item">
            ...
            <a href="{{ route('admin-preview.enquiries.index') }}" class="qa-item">
            ...
            <a href="{{ route('admin-preview.settings.edit') }}" class="qa-item">
