...
<form method="POST" action="{{ route('admin-preview.pages.update', $page) }}">
    @csrf @method('PUT')
    <div class="form-card">
        ...
        <div class="block-item" data-id="{{ $block->id }}">
            <div class="block-header">
                ...
                <div class="block-actions">
                    <form method="POST" action="{{ route('admin-preview.blocks.destroy', $block) }}" style="display:inline;" onsubmit="return confirm('Delete this block?')">
                        @csrf @method('DELETE')
...
<form method="POST" action="{{ route('admin-preview.pages.blocks.store', $page) }}">
    @csrf
