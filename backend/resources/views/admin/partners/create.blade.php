...
<form method="POST" action="{{ isset($partner) ? route('admin.partners.update', $partner) : route('admin.partners.store') }}">
    ...
    <div class="form-actions"><a href="{{ route('admin.partners.index') }}" class="btn btn-secondary">Cancel</a><button type="submit" class="btn btn-primary">{{ isset($partner) ? 'Update' : 'Create' }}</button></div>
</form>
