...
<form method="POST" action="{{ isset($program) ? route('admin.training.update', $program) : route('admin.training.store') }}">
    ...
    <div class="form-actions"><a href="{{ route('admin.training.index') }}" class="btn btn-secondary">Cancel</a><button type="submit" class="btn btn-primary">{{ isset($program) ? 'Update' : 'Create' }}</button></div>
</form>
