...
<form method="POST" action="{{ route('admin.training.update', $program) }}">
    @csrf @method('PUT')
    <div class="form-card">
    ...
    <div class="form-actions"><a href="{{ route('admin.training.index') }}" class="btn btn-secondary">Cancel</a><button type="submit" class="btn btn-primary">Update</button></div>
</form>
