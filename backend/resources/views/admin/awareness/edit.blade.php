...
<form method="POST" action="{{ route('admin.awareness.update', $initiative) }}">
    @csrf @method('PUT')
    <div class="form-card">
    ...
    <div class="form-actions"><a href="{{ route('admin.awareness.index') }}" class="btn btn-secondary">Cancel</a><button type="submit" class="btn btn-primary">Update</button></div>
</form>
