...
Route::post('/email/verify', [CustomerAuthController::class, 'verifyEmail'])->middleware(['auth:sanctum', 'throttle:5,1']);
Route::post('/email/confirm', [CustomerAuthController::class, 'confirmEmail'])->middleware('throttle:10,1');
