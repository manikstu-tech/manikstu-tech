...
<form method="GET" class="toolbar" id="ptToolbar">
    ...
    <?php if(request('dir')): ?><input type="hidden" name="dir" value="<?php echo e(request('dir')); ?>"><?php endif; ?>
    <div class="search-wrap">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search..." class="search-input">
    </div>
    <div class="cat-wrap">
...
<div class="pt-card">
    <div class="pt-scroll">
        <table class="pt-table">
            <thead>
                <tr>
                    <th><a href="<?php echo e($sortUrl('name')); ?>" class="th-sort <?php echo e($curSort === 'name' ? 'active' : ''); ?>">Name <?php echo $__env->make('admin.partners._sorticon', ['col' => 'name'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    <th><a href="<?php echo e($sortUrl('category')); ?>" class="th-sort <?php echo e($curSort === 'category' ? 'active' : ''); ?>">Category <?php echo $__env->make('admin.partners._sorticon', ['col' => 'category'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    <th>Website</th>
                    <th><a href="<?php echo e($sortUrl('status')); ?>" class="th-sort <?php echo e($curSort === 'status' ? 'active' : ''); ?>">Status <?php echo $__env->make('admin.partners._sorticon', ['col' => 'status'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    ...
                    <tr>
                        <td>
                            <div class="pt-name-cell">
                                <?php if($p->logo): ?>
                                    <img src="<?php echo e(asset('storage/' . $p->logo)); ?>" class="pt-logo" alt="<?php echo e($p->name); ?>">
                                <?php else: ?>
                                    <span class="pt-logo pt-logo-initial" style="color:<?php echo e($col['text']); ?>;"><?php echo e($initial); ?></span>
                                <?php endif; ?>
                                <div class="pt-name-info">
                                    <span class="pt-name"><?php echo e($p->name); ?></span>
                                    <?php if($tag): ?><span class="pt-tag"><?php echo e($tag); ?></span><?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td>
                            <?php if($cat): ?>
                                <span class="cat-pill" style="background:<?php echo e($col['bg']); ?>;color:<?php echo e($col['text']); ?>;"><?php echo e($cat); ?></span>
                            <?php else: ?>
                        ...
                        <td>
                            <?php if($host): ?>
                                <a href="<?php echo e($p->website_url); ?>" target="_blank" rel="noopener" class="pt-web">
                        ...
                        <td>
                            <div class="pt-actions">
                                <a href="<?php echo e(route('admin.partners.edit', $p)); ?>" class="act-btn" title="Edit">
                                ...
                                <div class="pt-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="<?php echo e(route('admin.partners.edit', $p)); ?>" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="<?php echo e(route('admin.partners.destroy', $p)); ?>" onsubmit="return confirm('Delete <?php echo e(addslashes($p->name)); ?>?')">
    ...
    <?php if($partners->hasPages()): ?>
        <?php $cur = $partners->currentPage(); $last = $partners->lastPage(); $prev = null; ?>
        <div class="pt-pagination">
            <a href="<?php echo e($partners->previousPageUrl() ?: '#'); ?>" class="pg-btn pg-arrow <?php echo e($partners->onFirstPage() ? 'disabled' : ''); ?>" aria-label="Previous">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>
            </a>
            <?php for($i = 1; $i <= $last; $i++): ?>
                <?php if($i <= 3 || $i == $last || abs($i - $cur) <= 1): ?>
                    <a href="<?php echo e($partners->url($i)); ?>" class="pg-btn <?php echo e($i == $cur ? 'active' : ''); ?>"><?php echo e($i); ?></a>
                    <?php $prev = $i; ?>
                <?php elseif($prev !== '...'): ?>
                ...
                <?php endif; ?>
            <?php endfor; ?>
            <a href="<?php echo e($partners->nextPageUrl() ?: '#'); ?>" class="pg-btn pg-arrow <?php echo e(!$partners->hasMorePages() ? 'disabled' : ''); ?>" aria-label="Next">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/admin/partners/index.blade.php ENDPATH**/ ?>