<?php $__env->startSection('title', 'Telecalling'); ?>
...
<div class="tc-cols">
    ...
    <div class="card">
        <div class="card-head">
            <h3>Call Queue</h3>
            <span class="head-meta"><?php echo e(count($queue)); ?> pending</span>
        </div>
        <div class="queue">
            <?php $__currentLoopData = $queue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="queue-item">
                    <span class="avatar"><?php echo e($initials($q['name'])); ?></span>
                    <div class="queue-body">
                        <p class="queue-name"><?php echo e($q['name']); ?></p>
                        <p class="queue-note"><?php echo e($q['note']); ?></p>
                        <p class="queue-due"><span class="due-tag"><?php echo e($q['tag']); ?></span> · <?php echo e($q['due']); ?></p>
                    </div>
                    <div class="queue-actions">
                        <a href="tel:<?php echo e($q['phone']); ?>" class="act-btn call" title="Call">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                        </a>
                        <button type="button" class="act-btn msg" title="Message" onclick="tcToast('Messaging <?php echo e($q['name']); ?> — coming soon')">
            ...
            <table class="tc-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="strong"><?php echo e($r['name']); ?></td>
                            <td><?php echo e($r['time']); ?></td>
                            <td>
                                <span class="call-type <?php echo e($r['type'] === 'Incoming' ? 'in' : 'out'); ?>">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <?php if($r['type'] === 'Incoming'): ?><polyline points="7 17 17 17 17 7"/><line x1="7" y1="7" x2="17" y2="17"/><?php else: ?><polyline points="17 7 7 7 7 17"/><line x1="17" y1="17" x2="7" y2="7"/><?php endif; ?>
                                    </svg>
                                    <?php echo e($r['type']); ?>
...
<?php echo $__env->make('telecalling.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/telecalling/telecalling.blade.php ENDPATH**/ ?>