...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('favicon-180.png')); ?>">
...
<body>
    ...
    <img src="<?php echo e(asset('patterns/village-scene.png')); ?>" alt="" class="bg-village" />
    ...
    <div class="login-card">
        ...
        <div class="card-body">
            <div class="logo-wrap">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="Manikstu Agro" class="login-logo" />
            </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="error-msg" role="alert"><?php echo e($message); ?></div>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                ...
                <div class="field-group" id="roleGroup">
                    ...
                    <div class="role-cards">
                        ...
                        <label class="role-card" data-role="developer">
                            ...
                            <span class="role-card-name">Farmers Connect</span>
                        </label>
                        ...
                        <label class="role-card" data-role="telecaller">
                            ...
                            <span class="role-card-name">HR</span>
                        </label>
                    </div>
                </div>
    ...
    <div class="footer-strip">
        ...
        <p>&copy; <?php echo e(date('Y')); ?> Manikstu Agro Private Limited. All Rights Reserved.</p>
    </div>
...
<?php /**PATH E:\Manikstu Website\backend\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>