...
<div class="tc-toolbar">
    <div>
        ...
        <p class="tc-sub"><?php echo e(count($allOrders)); ?> orders this month</p>
    </div>
    <div class="chips">
        ...
        <table class="tc-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php [$tx, $bg] = $statusColors[$o['status']] ?? ['#5A5A5A', 'rgba(90,90,90,0.10)']; ?>
                    <tr>
                        <td><a href="<?php echo e(route('telecalling.order.show', $o['id'])); ?>" class="ord-id"><?php echo e($o['id']); ?></a></td>
                        <td><?php echo e($o['farmer']); ?></td>
                        <td><?php echo e($o['product']); ?></td>
                        <td>₹<?php echo e(number_format($o['amount'])); ?></td>
                        <td><span class="tc-badge" style="background:<?php echo e($bg); ?>;color:<?php echo e($tx); ?>;"><?php echo e($o['status']); ?></span></td>
                        <td><?php echo e(explode(',', $o['date'])[0]); ?></td>
                        <td>
                            <a href="<?php echo e(route('telecalling.order.show', $o['id'])); ?>" class="eye-btn" title="View">
...
<?php echo $__env->make('telecalling.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/telecalling/orders.blade.php ENDPATH**/ ?>