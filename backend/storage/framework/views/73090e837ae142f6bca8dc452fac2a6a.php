...
<div class="stat-card" style="border-bottom: 2.5px solid <?php echo e($c); ?>;">
    <div class="stat-corner-art <?php echo e($artimg ? 'is-img' : ''); ?>" style="color: <?php echo e($c); ?>;">
        <?php if($artimg): ?>
            <img src="<?php echo e(asset($artimg)); ?>" alt="" class="stat-corner-img" />
        <?php else: ?>
            <svg viewBox="0 0 120 96" aria-hidden="true"><?php echo $arts[$art] ?? $arts['plants']; ?></svg>
        <?php endif; ?>
    </div>
    <div class="stat-top">
        <div class="stat-icon" style="background: <?php echo e($bg); ?>; color: <?php echo e($c); ?>;">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><?php echo $icons[$icon] ?? $icons['package']; ?></svg>
        </div>
        <?php if($badge): ?>
            <span class="stat-badge" style="background: <?php echo e($badgeC[0]); ?>; color: <?php echo e($badgeC[1]); ?>;">
                <?php if($trend === 'up'): ?>
    ...
    <div class="stat-number"><?php echo e($value); ?></div>
...
<?php /**PATH E:\Manikstu Website\backend\resources\views/components/admin/stat-card.blade.php ENDPATH**/ ?>