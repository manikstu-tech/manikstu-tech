...
<div class="job-card">
    <div class="job-scroll">
        <table class="job-table">
            <thead>
                <tr>
                    <th><a href="<?php echo e($sortUrl('title')); ?>" class="th-sort <?php echo e($curSort === 'title' ? 'active' : ''); ?>">Title <?php echo $__env->make('admin.careers._sorticon', ['col' => 'title'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    <th><a href="<?php echo e($sortUrl('department')); ?>" class="th-sort <?php echo e($curSort === 'department' ? 'active' : ''); ?>">Department <?php echo $__env->make('admin.careers._sorticon', ['col' => 'department'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    <th>Location</th>
                    <th>Type</th>
                    <th><a href="<?php echo e($sortUrl('status')); ?>" class="th-sort <?php echo e($curSort === 'status' ? 'active' : ''); ?>">Status <?php echo $__env->make('admin.careers._sorticon', ['col' => 'status'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    ...
                    <tr>
                        <td>
                            <div class="job-title-cell">
                                <span class="job-title"><?php echo e($job->title); ?></span>
                                <span class="job-ref">Ref: <?php echo e($ref); ?></span>
                            </div>
                        </td>
                        <td>
                            <?php if($job->department): ?>
                                <span class="dept-pill" style="background:<?php echo e($pill['bg']); ?>;color:<?php echo e($pill['text']); ?>;"><?php echo e($job->department); ?></span>
                            <?php else: ?>
                        ...
                        <td><span class="job-type"><?php echo e($typeLabel); ?></span></td>
                        <td>
                        ...
                        <td>
                            <div class="job-actions">
                                <a href="<?php echo e(route('admin.careers.edit', $job)); ?>" class="act-btn" title="Edit">
                                ...
                                <div class="job-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="<?php echo e(route('admin.careers.edit', $job)); ?>" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="<?php echo e(route('admin.careers.destroy', $job)); ?>" onsubmit="return confirm('Delete <?php echo e(addslashes($job->title)); ?>?')">
    ...
    <?php if($jobs->hasPages()): ?>
        <?php $cur = $jobs->currentPage(); $last = $jobs->lastPage(); $prev = null; ?>
        <div class="job-pagination">
            <a href="<?php echo e($jobs->previousPageUrl() ?: '#'); ?>" class="pg-btn pg-arrow <?php echo e($jobs->onFirstPage() ? 'disabled' : ''); ?>" aria-label="Previous">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>
            </a>
            <?php for($i = 1; $i <= $last; $i++): ?>
                <?php if($i <= 3 || $i == $last || abs($i - $cur) <= 1): ?>
                    <a href="<?php echo e($jobs->url($i)); ?>" class="pg-btn <?php echo e($i == $cur ? 'active' : ''); ?>"><?php echo e($i); ?></a>
                    <?php $prev = $i; ?>
                <?php elseif($prev !== '...'): ?>
                ...
                <?php endif; ?>
            <?php endfor; ?>
            <a href="<?php echo e($jobs->nextPageUrl() ?: '#'); ?>" class="pg-btn pg-arrow <?php echo e(!$jobs->hasMorePages() ? 'disabled' : ''); ?>" aria-label="Next">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/admin/careers/index.blade.php ENDPATH**/ ?>