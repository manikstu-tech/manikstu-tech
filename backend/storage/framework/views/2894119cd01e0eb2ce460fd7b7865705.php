<?php $__env->startSection('title', $sectionTitle); ?>

<?php $__env->startSection('content'); ?>
<div class="sec-head">
    <h1 class="sec-title"><?php echo e($sectionTitle); ?></h1>
...
<div class="sec-card">
    ...
    <h2><?php echo e($sectionTitle); ?> — Coming Soon</h2>
    ...
    <a href="<?php echo e(route('telecalling.dashboard')); ?>" class="sec-btn">← Back to Dashboard</a>
</div>
...
<?php echo $__env->make('telecalling.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/telecalling/section.blade.php ENDPATH**/ ?>