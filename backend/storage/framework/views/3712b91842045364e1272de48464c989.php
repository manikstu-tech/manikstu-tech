...
<div class="modal-overlay" id="<?php echo e($id); ?>" style="display:none;">
    <div class="modal-box">
        ...
        <p class="modal-message"><?php echo e($message); ?></p>
        <div class="modal-actions">
            <button type="button" class="modal-btn modal-btn-cancel" onclick="closeModal('<?php echo e($id); ?>')">Cancel</button>
...
<?php /**PATH E:\Manikstu Website\backend\resources\views/components/admin/modal.blade.php ENDPATH**/ ?>