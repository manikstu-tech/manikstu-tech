...
<a href="<?php echo e(route('telecalling.orders')); ?>" class="back-btn">
...
<div class="od-head">
    <div>
        <h1 class="od-title">Order #<?php echo e($order['id']); ?> <span class="tc-badge" style="background:<?php echo e($sbg); ?>;color:<?php echo e($stx); ?>;"><?php echo e($order['status']); ?></span></h1>
        <p class="od-sub">Placed on <?php echo e($order['date']); ?></p>
    </div>
...
<div class="card info-card">
    <div class="info-col">
        ...
        <div class="info-line"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4.4 3.6-8 8-8s8 3.6 8 8"/></svg><span class="v"><?php echo e($order['farmer']); ?></span></div>
        <div class="info-line"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg><a href="tel:<?php echo e($order['phone']); ?>" class="v"><?php echo e($order['phone']); ?></a></div>
        <div class="info-line"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg><span class="v"><?php echo e($order['location']); ?></span></div>
    </div>
    <div class="info-col">
        ...
        <div class="kv"><span class="k">Quantity</span><span class="sep">:</span><span class="v"><?php echo e($order['qty']); ?></span></div>
        <div class="kv"><span class="k">Amount</span><span class="sep">:</span><span class="v">₹<?php echo e(number_format($order['amount'])); ?></span></div>
        <div class="kv"><span class="k">Seller</span><span class="sep">:</span><span class="v"><?php echo e($order['seller']); ?></span></div>
        <div class="kv"><span class="k">Payment</span><span class="sep">:</span><span class="v" style="color:<?php echo e($paid ? '#3A7030' : '#B4711A'); ?>;font-weight:700;"><?php echo e($order['payment']); ?></span></div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="stepper">
        <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $n = $i + 1; $done = $n < $current; $isCur = $n === $current; ?>
            <div class="step">
                <?php if($i > 0): ?><span class="step-line <?php echo e($n <= $current ? 'done' : ''); ?>"></span><?php endif; ?>
                <span class="step-circle <?php echo e($done ? 'done' : ($isCur ? 'current' : '')); ?>">
                    <?php if($done): ?><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg><?php else: ?><?php echo e($n); ?><?php endif; ?>
                </span>
                <span class="step-label <?php echo e($isCur ? 'current' : ''); ?>"><?php echo e($step); ?></span>
                <?php if($n <= $current): ?><span class="step-time"><?php echo e(explode(',', $order['date'])[0]); ?></span><?php endif; ?>
            </div>
...
<div class="od-grid">
    <div class="card">
        ...
        <div class="pad">
            <div class="route-box">
                ...
                <div class="route-caption"><?php echo e($order['seller']); ?> Warehouse → Local Hub → <?php echo e($city); ?></div>
            </div>
            <p class="route-meta">Last updated: Today, <?php echo e(now()->format('h:i A')); ?> · Expected delivery: <?php echo e(now()->addDay()->format('d M Y')); ?> (By EOD)</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="pad">
            ...
            <div class="kv"><span class="k">Tracking ID</span><span class="sep">:</span><span class="v mono">ML-<?php echo e(substr($trackDigits . '0000000000', 0, 10)); ?></span></div>
...
<div class="od-help">
    ...
    <a href="<?php echo e(route('telecalling.complaints')); ?>" class="btn-issue">
...
async function shareOrder(btn) {
    var data = {
        title: 'Order #<?php echo e($order['id']); ?>',
        text: 'Order #<?php echo e($order['id']); ?> — <?php echo e($order['product']); ?> for <?php echo e($order['farmer']); ?> (<?php echo e($order['status']); ?>)',
...
<?php echo $__env->make('telecalling.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/telecalling/order-detail.blade.php ENDPATH**/ ?>