...
<a href="<?php echo e(route('telecalling.franchise')); ?>" class="back-btn">
...
<div class="fd-head">
    <div>
        <h1 class="fd-title"><?php echo e($lead['name']); ?> <span class="tc-badge" style="background:<?php echo e($sbg); ?>;color:<?php echo e($stx); ?>;"><?php echo e($lead['status']); ?></span></h1>
        <p class="fd-sub">Lead ID: <?php echo e($lead['id']); ?> · Enquiry on <?php echo e($lead['date']); ?></p>
    </div>
...
<div class="fd-grid-top">
    <div class="card">
        ...
        <div class="pad">
            <div class="li-grid">
                <div class="li"><span class="li-k">Mobile</span><a href="tel:<?php echo e($lead['mobile']); ?>" class="li-v"><?php echo e($lead['mobile']); ?></a></div>
                <div class="li"><span class="li-k">Location</span><span class="li-v"><?php echo e($lead['location']); ?></span></div>
                <div class="li"><span class="li-k">Investment Range</span><span class="li-v"><?php echo e($lead['investment']); ?></span></div>
                <div class="li"><span class="li-k">Land Available</span><span class="li-v"><?php echo e($lead['land']); ?></span></div>
                <div class="li"><span class="li-k">Experience</span><span class="li-v"><?php echo e($lead['experience']); ?></span></div>
                <div class="li"><span class="li-k">Desired Farm Size</span><span class="li-v"><?php echo e($lead['farmSize']); ?></span></div>
                <div class="li"><span class="li-k">Lead Source</span><span class="li-v"><?php echo e($lead['source']); ?></span></div>
                <div class="li"><span class="li-k">Assigned To</span><span class="li-v"><?php echo e($lead['assigned']); ?></span></div>
            </div>
        </div>
    </div>
        ...
        <div class="pad">
            <div class="next-box">
                <div class="next-title">
                    ...
                    <?php echo e($lead['next']['title']); ?>

                </div>
                <p class="next-meta"><?php echo e($lead['next']['date']); ?><br>Location: <?php echo e($lead['next']['location']); ?></p>
                <button type="button" class="next-btn" onclick="fdToast('Reschedule — coming soon')">View / Reschedule</button>
            </div>
            <p class="notes-label">Notes</p>
            <p class="notes-text"><?php echo e($lead['notes']); ?></p>
        </div>
    </div>
</div>
            ...
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="vstep-item <?php echo e($loop->last ? 'last' : ''); ?>">
                    ...
                    <div class="vstep-body">
                        <p class="vstep-label <?php echo e($isDone ? 'done' : ''); ?>"><?php echo e($step); ?></p>
                        <p class="vstep-note"><?php echo e($isDone ? $lead['date'] : 'Pending'); ?></p>
                    </div>
                </div>
...
<div class="fd-grid-bottom">
    <div class="card">
        ...
        <div class="tc-table-wrap">
            <table class="tc-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $lead['calls']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($c['time']); ?></td>
                            <td><?php echo e($c['by']); ?></td>
                            <td class="strong"><?php echo e($c['activity']); ?></td>
    ...
    <div class="card">
        ...
        <div class="pad">
            <div class="qa-grid">
                <a href="tel:<?php echo e($lead['mobile']); ?>" class="qa-btn">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    Call Lead
                </a>
                <a href="https://wa.me/<?php echo e(preg_replace('/\D+/', '', $lead['mobile'])); ?>" target="_blank" rel="noopener" class="qa-btn">
...
<?php echo $__env->make('telecalling.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/telecalling/franchise-detail.blade.php ENDPATH**/ ?>