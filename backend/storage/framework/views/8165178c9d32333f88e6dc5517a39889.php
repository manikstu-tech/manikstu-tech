...
.dash-footer-left { left: 0; width: 34%; max-width: 340px; background-image: url('<?php echo e(asset("patterns/footer-left.png")); ?>'); background-position: left bottom; }
.dash-footer-right { right: 0; width: 33%; max-width: 360px; background-image: url('<?php echo e(asset("patterns/footer-right.png")); ?>'); background-position: right bottom; }
...
<div class="dash-header">
    <div>
        ...
        <p class="dash-subtitle">Welcome back, <?php echo e(Auth::user()->name); ?>. Here's what's happening today.</p>
    ...
    <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>">
        <label class="date-pill">
            ...
            <span><?php echo e(($selectedDate ?? now())->format('d F Y')); ?></span>
            ...
            <input type="date" name="date" value="<?php echo e(($selectedDate ?? now())->format('Y-m-d')); ?>" max="<?php echo e(now()->format('Y-m-d')); ?>" onchange="this.form.submit()" onclick="if(this.showPicker){try{this.showPicker()}catch(e){}}" aria-label="Select date" />
        </label>
    </form>
</div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.stat-card','data' => ['value' => ''.e($stats['products']).'','label' => 'Total Products','icon' => 'package','color' => 'green','artimg' => 'patterns/card-plant.png','badge' => '+2 this week']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['value' => ''.e($stats['products']).'','label' => 'Total Products','icon' => 'package','color' => 'green','artimg' => 'patterns/card-plant.png','badge' => '+2 this week']); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal3c3cb599308b2d9971dae437d0b6bab6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.stat-card','data' => ['value' => ''.e($stats['orders']).'','label' => 'Total Orders','icon' => 'cart','color' => 'green','artimg' => 'patterns/card-goat.png','badge' => '+12%']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => ''.e($stats['orders']).'','label' => 'Total Orders','icon' => 'cart','color' => 'green','artimg' => 'patterns/card-goat.png','badge' => '+12%']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6)): ?>
<?php $attributes = $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6; ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal3c3cb599308b2d9971dae437d0b6bab6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.stat-card','data' => ['value' => ''.e($stats['enquiries']).'','label' => 'Active Enquiries','icon' => 'message','color' => 'amber','artimg' => 'patterns/card-plant.png','badge' => ''.e($stats['enquiries']).' pending','trend' => 'dot','accent' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => ''.e($stats['enquiries']).'','label' => 'Active Enquiries','icon' => 'message','color' => 'amber','artimg' => 'patterns/card-plant.png','badge' => ''.e($stats['enquiries']).' pending','trend' => 'dot','accent' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6)): ?>
<?php $attributes = $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6; ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal3c3cb599308b2d9971dae437d0b6bab6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.stat-card','data' => ['value' => '₹'.e($stats['revenue'] > 0 ? number_format($stats['revenue'] / 100000, 1) . 'L' : '0').'','label' => 'Total Revenue','icon' => 'dollar','color' => 'green','art' => 'chart','badge' => '+18%']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => '₹'.e($stats['revenue'] > 0 ? number_format($stats['revenue'] / 100000, 1) . 'L' : '0').'','label' => 'Total Revenue','icon' => 'dollar','color' => 'green','art' => 'chart','badge' => '+18%']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6)): ?>
<?php $attributes = $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6; ?>
...
<div class="content-grid">
    <div class="card">
        <div class="card-head">
            ...
            <a href="<?php echo e(route('admin.enquiries.index')); ?>" class="view-all">View all <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></a>
        </div>
        <div class="act-list" id="actList">
            <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="act-row">
                    <span class="act-ic ic-<?php echo e($a['tone']); ?>"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><?php echo $a['ic']; ?></svg></span>
                    <div class="act-body">
                        <div class="act-title"><?php echo e($a['title']); ?></div>
                        <div class="act-sub"><?php echo e($a['sub']); ?></div>
                    </div>
                    <div class="act-meta">
                        <span class="act-time"><?php echo e($a['time']); ?></span>
                        <span class="act-dot dot-<?php echo e($a['dot']); ?>"></span>
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="qa-list">
            <a href="<?php echo e(route('admin.products.create')); ?>" class="qa-item">
            ...
            <a href="<?php echo e(route('admin.blog.create')); ?>" class="qa-item">
            ...
            <a href="<?php echo e(route('admin.enquiries.index')); ?>" class="qa-item">
            ...
            <a href="<?php echo e(route('admin.settings.edit')); ?>" class="qa-item">
...
<div class="dash-footer">
    ...
    <p class="dash-copyright">&copy; <?php echo e(date('Y')); ?> Manikstu Agro Private Limited. All Rights Reserved.</p>
</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>