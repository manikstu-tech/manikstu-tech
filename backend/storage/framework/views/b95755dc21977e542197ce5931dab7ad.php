...
<form method="GET" class="toolbar" id="teamToolbar">
    ...
    <div class="search-wrap">
        ...
        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search members..." class="search-input">
    </div>
...
<div class="tm-card">
    <div class="tm-scroll">
        <table class="tm-table">
            <thead>
                <tr>
                    <th><a href="<?php echo e($sortUrl('name')); ?>" class="th-sort <?php echo e($curSort === 'name' ? 'active' : ''); ?>">Name <?php echo $__env->make('admin.team._sorticon', ['col' => 'name'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    <th><a href="<?php echo e($sortUrl('role')); ?>" class="th-sort <?php echo e($curSort === 'role' ? 'active' : ''); ?>">Role <?php echo $__env->make('admin.team._sorticon', ['col' => 'role'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    <th><a href="<?php echo e($sortUrl('status')); ?>" class="th-sort <?php echo e($curSort === 'status' ? 'active' : ''); ?>">Status <?php echo $__env->make('admin.team._sorticon', ['col' => 'status'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a></th>
                    ...
                    <tr>
                        <td>
                            <div class="tm-name-cell">
                                <?php if($m->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $m->image)); ?>" class="tm-avatar" alt="<?php echo e($m->name); ?>">
                                <?php else: ?>
                                    <span class="tm-avatar tm-avatar-initial" style="background:<?php echo e($abg); ?>;color:<?php echo e($pill['text']); ?>;"><?php echo e($initial); ?></span>
                                <?php endif; ?>
                                <div class="tm-name-info">
                                    <span class="tm-name"><?php echo e($m->name); ?></span>
                                    <?php if($m->email): ?><span class="tm-email"><?php echo e($m->email); ?></span><?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td><span class="role-pill" style="background:<?php echo e($pill['bg']); ?>;color:<?php echo e($pill['text']); ?>;"><?php echo e($m->role); ?></span></td>
                        <td>
                            <?php if($m->is_active): ?>
                        ...
                        <td>
                            <div class="tm-actions">
                                <a href="<?php echo e(route('admin.team.edit', $m)); ?>" class="act-btn" title="Edit">
                                ...
                                <div class="tm-menu">
                                    ...
                                    <div class="kebab-menu">
                                        <a href="<?php echo e(route('admin.team.edit', $m)); ?>" class="kebab-item">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="<?php echo e(route('admin.team.destroy', $m)); ?>" onsubmit="return confirm('Delete <?php echo e(addslashes($m->name)); ?>?')">
    ...
    <?php if($members->hasPages()): ?>
        <?php $cur = $members->currentPage(); $last = $members->lastPage(); $prev = null; ?>
        <div class="tm-pagination">
            <a href="<?php echo e($members->previousPageUrl() ?: '#'); ?>" class="pg-btn pg-arrow <?php echo e($members->onFirstPage() ? 'disabled' : ''); ?>" aria-label="Previous">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>
            </a>
            <?php for($i = 1; $i <= $last; $i++): ?>
                <?php if($i <= 3 || $i == $last || abs($i - $cur) <= 1): ?>
                    <a href="<?php echo e($members->url($i)); ?>" class="pg-btn <?php echo e($i == $cur ? 'active' : ''); ?>"><?php echo e($i); ?></a>
                    <?php $prev = $i; ?>
                <?php elseif($prev !== '...'): ?>
                ...
                <?php endif; ?>
            <?php endfor; ?>
            <a href="<?php echo e($members->nextPageUrl() ?: '#'); ?>" class="pg-btn pg-arrow <?php echo e(!$members->hasMorePages() ? 'disabled' : ''); ?>" aria-label="Next">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/admin/team/index.blade.php ENDPATH**/ ?>