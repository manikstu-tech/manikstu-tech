<?php $__env->startSection('title', 'Telecalling Dashboard'); ?>
...
<div class="tc-head">
    <div>
        <h1 class="tc-title"><?php echo e($greet); ?>, <?php echo e(Str::of(Auth::user()->name)->explode(' ')->first()); ?></h1>
...
<div class="stat-grid">
    ...
    ?>
    <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $num, $tone, $path, $trend]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="stat-card">
            <span class="stat-ic ic-<?php echo e($tone); ?>"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><?php echo $path; ?></svg></span>
            <div class="stat-label"><?php echo e($label); ?></div>
            <div class="stat-num"><?php echo e($num); ?></div>
            <div class="stat-trend"><?php echo e($trend); ?></div>
        </div>
...
<div class="tc-grid">
    <div class="card">
        <div class="card-head"><h3>Call Queue</h3><span class="head-note"><?php echo e($queue->count()); ?> to call</span></div>
        <div class="pad-sm">
            <?php $__empty_1 = true; $__currentLoopData = $queue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="call-item">
                    <span class="call-av"><?php echo e($initials($lead->name) ?: 'L'); ?></span>
                    <div class="call-main">
                        <div class="call-name"><?php echo e($lead->name); ?></div>
                        <div class="call-sub"><?php echo e($lead->type ? ucwords(str_replace('_',' ',$lead->type)).' · ' : ''); ?><?php echo e(Str::limit($lead->message, 38)); ?></div>
                        <div class="call-meta"><?php echo e($lead->phone ?: 'No phone'); ?> · <?php echo e($lead->created_at->diffForHumans()); ?></div>
                    </div>
                    <?php if($lead->phone): ?>
                        <div class="call-actions">
                            <a class="ic-round ic-call" href="tel:<?php echo e($lead->phone); ?>" title="Call"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg></a>
                            <a class="ic-round ic-wa" href="https://wa.me/<?php echo e($waNum($lead->phone)); ?>" target="_blank" rel="noopener" title="WhatsApp"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.5 8.5 0 0 1-12.4 7.5L3 20l1.1-5.4A8.5 8.5 0 1 1 21 11.5z"/></svg></a>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <div class="card">
        ...
        <div class="donut-wrap">
            <div class="donut" style="background:<?php echo e($donut); ?>"><div class="donut-c"><div class="donut-n"><?php echo e($stats['total']); ?></div><div class="donut-l">Total Leads</div></div></div>
            <div class="legend">
                <?php $__currentLoopData = $segs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$lbl, $cnt, $col]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="leg-row"><span class="sw" style="background:<?php echo e($col); ?>"></span><span class="ln"><?php echo e($lbl); ?></span><span class="lv"><?php echo e($cnt); ?></span><span class="lp">(<?php echo e($stats['total'] ? round($cnt / max(1,$stats['total']) * 100) : 0); ?>%)</span></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        <div class="quote">
        ...
        <table class="tc-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><strong><?php echo e($lead->name); ?></strong><?php if($lead->email): ?><div class="muted"><?php echo e($lead->email); ?></div><?php endif; ?></td>
                        <td><?php echo e($lead->phone ?: '—'); ?></td>
                        <td><?php echo e($lead->type ? ucwords(str_replace('_',' ',$lead->type)) : '—'); ?></td>
                        <td class="muted" title="<?php echo e($lead->message); ?>"><?php echo e(Str::limit($lead->message, 38)); ?></td>
                        <td><?php echo $badge($lead->status); ?></td>
                        <td><?php echo e($lead->created_at->format('d M Y')); ?></td>
                        <td><?php if($lead->phone): ?><a href="tel:<?php echo e($lead->phone); ?>" class="call-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>Call</a><?php else: ?><span class="muted">—</span><?php endif; ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div class="tc-footer">
    ...
    <p class="tc-copy">&copy; <?php echo e(date('Y')); ?> Manikstu Agro Private Limited. All Rights Reserved.</p>
</div>
...
.tc-foot-left { left:0; width:34%; max-width:340px; background-image:url('<?php echo e(asset("patterns/footer-left.png")); ?>'); background-position:left bottom; }
.tc-foot-right { right:0; width:33%; max-width:360px; background-image:url('<?php echo e(asset("patterns/footer-right.png")); ?>'); background-position:right bottom; }
...
<?php echo $__env->make('telecalling.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/telecalling/dashboard.blade.php ENDPATH**/ ?>