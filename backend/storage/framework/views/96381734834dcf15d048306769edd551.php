...
.thead-plant { position: absolute; bottom: -6px; width: 54px; height: 46px; opacity: 0.45; background-image: url('<?php echo e(asset("patterns/card-plant.png")); ?>'); background-repeat: no-repeat; background-size: contain; pointer-events: none; }
...
.prod-footer-left { left: 0; width: 42%; max-width: 460px; background-image: url('<?php echo e(asset("patterns/footer-left.png")); ?>'); background-position: left bottom; }
.prod-footer-right { right: 0; width: 46%; max-width: 520px; background-image: url('<?php echo e(asset("patterns/footer-right.png")); ?>'); background-position: right bottom; }
...
<div class="prod-toolbar">
    <form method="GET" class="toolbar-left">
        <div class="search-wrap">
            ...
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search products..." class="prod-search">
        </div>
        <select name="category" class="prod-select" onchange="this.form.submit()">
            <option value="">All Categories</option>
            <?php $__currentLoopData = ($categories ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($cat->id); ?>" <?php echo e((string) request('category') === (string) $cat->id ? 'selected' : ''); ?>><?php echo e($cat->name); ?></option>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td>
                        <div style="display:flex;align-items:center;gap:12px;">
                            <?php if($product->image): ?>
                                <img src="<?php echo e(\Illuminate\Support\Str::startsWith($product->image, ['http','/']) ? $product->image : asset('storage/' . $product->image)); ?>" class="cell-img" alt="" onerror="this.style.visibility='hidden'">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <div>
                                <a href="<?php echo e(route('admin.products.show', $product)); ?>" class="prod-name-link"><strong><?php echo e($product->name); ?></strong></a>
                                <?php if($product->is_featured): ?><br><small style="color:#C4952A;">Featured</small><?php endif; ?>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <form method="POST" action="<?php echo e(route('admin.products.togglePublish', $product)); ?>" style="display:inline;">
                            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                            <button type="submit" class="status-toggle" title="Click to <?php echo e($product->is_active ? 'unpublish' : 'publish'); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['type' => $product->is_active ? 'green' : 'gold','dot' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->is_active ? 'green' : 'gold'),'dot' => true]); ?><?php echo e($product->is_active ? 'Published' : 'Draft'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <td>
                        <div class="row-actions" style="justify-content:flex-end;">
                            <a href="<?php echo e(route('admin.products.show', $product)); ?>" class="act-view" title="View details"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg></a>
                            <a href="<?php echo e(route('admin.products.edit', $product)); ?>" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></a>
                            <button type="button" class="btn-delete" onclick="openModal('deleteModal','<?php echo e(route('admin.products.destroy', $product)); ?>')" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
                        </div>
                    </td>
                </tr>
                ...
                <tr class="empty-row">
                    <td colspan="5" style="padding:0;">
                        <div class="prod-empty">
                            ...
                            <a href="<?php echo e(route('admin.products.create')); ?>" class="empty-btn">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
                                Add Product
                            </a>
                        </div>
    ...
    <?php if($products->hasPages()): ?>
        <div class="prod-pagination"><?php echo e($products->links()); ?></div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/admin/products/index.blade.php ENDPATH**/ ?>