<?php $__env->startSection('title', 'Delivery Tracking'); ?>
...
<div class="tc-toolbar">
    <div>
        ...
        <p class="tc-sub"><?php echo e(count($deliveries)); ?> deliveries currently active</p>
    </div>
</div>
        ...
        <table class="tc-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php [$tx, $bg] = $statusColors[$d['status']] ?? ['#5A5A5A', 'rgba(90,90,90,0.10)']; ?>
                    <tr>
                        <td><a href="<?php echo e(route('telecalling.order.show', $d['id'])); ?>" class="ord-id"><?php echo e($d['id']); ?></a></td>
                        <td><?php echo e($d['farmer']); ?></td>
                        <td><?php echo e($d['location']); ?></td>
                        <td><?php echo e($d['product']); ?></td>
                        <td><span class="tc-badge" style="background:<?php echo e($bg); ?>;color:<?php echo e($tx); ?>;"><?php echo e($d['status']); ?></span></td>
                        <td><?php echo e($d['expected']); ?></td>
                        <td>
                            <a href="<?php echo e(route('telecalling.order.show', $d['id'])); ?>" class="eye-btn" title="View">
...
<?php echo $__env->make('telecalling.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/telecalling/delivery.blade.php ENDPATH**/ ?>