...
<div class="filter-bar">
    <form method="GET" class="filter-form">
        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search posts..." class="filter-input">
    ...
    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td>
                ...
                <?php if($post->is_featured): ?><br><small style="color:#C4952A;">Featured</small><?php endif; ?>
            </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['type' => $post->is_published ? 'green' : 'gold','dot' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->is_published ? 'green' : 'gold'),'dot' => true]); ?><?php echo e($post->is_published ? 'Published' : 'Draft'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></td>
            <td><?php echo e($post->published_at?->format('M d, Y') ?? $post->created_at->format('M d, Y')); ?></td>
            <td>
                <div class="table-actions">
                    <a href="<?php echo e(route('admin.blog.edit', $post)); ?>" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></a>
                    <button type="button" class="btn-delete" onclick="openModal('deleteModal','<?php echo e(route('admin.blog.destroy', $post)); ?>')" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
                </div>
            </td>
        </tr>
...
<div class="table-pagination"><?php echo e($posts->links()); ?></div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>