...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Telecalling'); ?> - Manikstu</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar-strip { height: 30px; flex-shrink: 0; background-image: url('<?php echo e(asset("patterns/saura-border-tight.png")); ?>'); background-size: auto 100%; background-repeat: repeat-x; background-position: center; opacity: 0.4; pointer-events: none; border-bottom: 1px solid var(--light-grey); }
    ...
    <div class="app-shell" id="appShell">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-logo">
                <a href="<?php echo e(route('telecalling.dashboard')); ?>"><img src="<?php echo e(asset('logo.png')); ?>" alt="Manikstu Agro" /></a>
            </div>
            ...
            <nav class="sidebar-nav">
                ...
                <?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$key, $label, $icon]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('telecalling.' . $key)); ?>" class="nav-item <?php echo e(request()->routeIs('telecalling.' . $key) ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><?php echo $icon; ?></svg>
                        <?php echo e($label); ?>
                ...
                <div class="topbar-right">
                    ...
                    <div class="bell-wrap">
                        <button class="topbar-bell" aria-label="Notifications" aria-expanded="false" onclick="toggleNotif(event)">
                            ...
                            <?php if($tcUnread > 0): ?><span class="bell-badge" id="bellBadge"><?php echo e($tcUnread > 9 ? '9+' : $tcUnread); ?></span><?php endif; ?>
                        </button>
                        <div class="notif-panel" id="notifPanel" hidden>
                            <div class="notif-head">
                                <span>Notifications</span>
                                <?php if($tcUnread > 0): ?>
                                    <form method="POST" action="<?php echo e(route('telecalling.notifications.read')); ?>" style="margin:0;">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="notif-list">
                                <?php $__empty_1 = true; $__currentLoopData = $tcNotifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="notif-item <?php echo e($n['unread'] ? 'unread' : ''); ?>">
                                        <span class="notif-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><?php echo $tcIcons[$n['icon']] ?? ''; ?></svg></span>
                                        <div class="notif-body">
                                            <p class="notif-title"><?php echo e($n['title']); ?></p>
                                            <p class="notif-text"><?php echo e($n['text']); ?></p>
                                            <p class="notif-time"><?php echo e($n['time']); ?></p>
                                        </div>
                                        <?php if($n['unread']): ?><span class="notif-dot"></span><?php endif; ?>
                                    </div>
                    ...
                    <div class="topbar-user">
                        ...
                        <div>
                            <p class="topbar-user-name"><?php echo e(Auth::user()->name); ?></p>
                            <p class="topbar-user-role"><?php echo e(ucfirst(Auth::user()->role)); ?></p>
                        </div>
                    </div>
                </div>
            </header>
...
<?php /**PATH E:\Manikstu Website\backend\resources\views/telecalling/layouts/app.blade.php ENDPATH**/ ?>