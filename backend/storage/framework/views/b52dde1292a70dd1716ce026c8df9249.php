...
.cat-art { position: absolute; right: 0; top: -6px; width: 58%; max-width: 660px; height: 130px; z-index: 0; background-image: url('<?php echo e(asset("patterns/category-header.png")); ?>'); background-size: contain; background-position: right center; background-repeat: no-repeat; -webkit-mask-image: linear-gradient(to right, transparent 0%, #000 20%); mask-image: linear-gradient(to right, transparent 0%, #000 20%); }
...
.cat-footer-left { left: 0; width: 42%; max-width: 460px; background-image: url('<?php echo e(asset("patterns/footer-left.png")); ?>'); background-position: left bottom; }
.cat-footer-right { right: 0; width: 46%; max-width: 520px; background-image: url('<?php echo e(asset("patterns/footer-right.png")); ?>'); background-position: right bottom; }
...
<div class="cat-toolbar">
    <form method="GET" class="toolbar-left">
        <div class="search-wrap">
            ...
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search categories..." class="cat-search">
        </div>
        <select name="type" class="cat-select">
            ...
            <option value="gallery" <?php echo e(request('type') === 'gallery' ? 'selected' : ''); ?>>Gallery</option>
            <option value="training" <?php echo e(request('type') === 'training' ? 'selected' : ''); ?>>Training</option>
        </select>
    ...
    <table class="cat-table">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><strong><?php echo e($category->name); ?></strong><br><small style="color:#999;"><?php echo e($category->slug); ?></small></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['type' => 'green']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'green']); ?><?php echo e(ucfirst($category->type)); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></td>
                    ...
                    <td><?php if (isset($component)) { $__componentOriginal92e51077c3bdcbfa01c516c134fd0f33 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.badge','data' => ['type' => $category->is_active ? 'green' : 'red','dot' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($category->is_active ? 'green' : 'red'),'dot' => true]); ?><?php echo e($category->is_active ? 'Active' : 'Inactive'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33)): ?>
<?php $attributes = $__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33; ?>
<?php unset($__attributesOriginal92e51077c3bdcbfa01c516c134fd0f33); ?>
...
<?php endif; ?></td>
                    <td>
                        <div class="row-actions" style="justify-content:flex-end;">
                            <a href="<?php echo e(route('admin.categories.edit', $category)); ?>" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></a>
                            <button type="button" class="btn-delete" onclick="openModal('deleteModal','<?php echo e(route('admin.categories.destroy', $category)); ?>')" title="Delete"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
                        </div>
                    </td>
                </tr>
                ...
                <tr class="empty-row">
                    <td colspan="5" style="padding:0;">
                        <div class="cat-empty">
                            ...
                            <a href="<?php echo e(route('admin.categories.create')); ?>" class="empty-btn">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
                                Add Category
                            </a>
                        </div>
    ...
    <?php if($categories->hasPages()): ?>
        <div class="cat-pagination"><?php echo e($categories->links()); ?></div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Manikstu Website\backend\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>