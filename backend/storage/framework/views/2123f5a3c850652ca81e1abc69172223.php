...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Manikstu Admin</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar-strip {
            height: 30px;
            flex-shrink: 0;
            background-image: url('<?php echo e(asset("patterns/saura-border-tight.png")); ?>');
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-logo">
                <a href="<?php echo e(route('admin.dashboard')); ?>">
                    <img src="<?php echo e(asset('logo.png')); ?>" alt="Manikstu Agro" />
                </a>
            </div>
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo e(route('admin.blog.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.blog*') ? 'active' : ''); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                    Blog Posts
                </a>
                <a href="<?php echo e(route('admin.press.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.press*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.team.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.team*') ? 'active' : ''); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Team
                </a>
                <a href="<?php echo e(route('admin.careers.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.careers*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.training.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.training*') ? 'active' : ''); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                    Training
                </a>
                <a href="<?php echo e(route('admin.testimonials.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.testimonials*') ? 'active' : ''); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                    Testimonials
                </a>
                <a href="<?php echo e(route('admin.partners.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.partners*') ? 'active' : ''); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Partners
                </a>

                <p class="nav-group-label">System</p>
                <a href="<?php echo e(route('admin.settings.edit')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.settings*') ? 'active' : ''); ?>">
            ...
            <div class="sidebar-user">
                <div class="sidebar-user-inner">
                    ...
                    <div class="user-info">
                        ...
                        <span class="user-role role-<?php echo e(Auth::user()->role); ?>"><?php echo e(ucfirst(Auth::user()->role)); ?></span>
                    </div>
                </div>
                ...
                <div class="topbar-right">
                    <div class="topbar-bell-wrap" id="bellWrap">
                        <button type="button" class="topbar-bell" onclick="toggleBellMenu()" aria-label="Notifications" aria-haspopup="true" aria-expanded="false" id="bellToggle">
                            ...
                            <?php if($notifCount > 0): ?><span class="bell-badge"><?php echo e($notifCount > 9 ? '9+' : $notifCount); ?></span><?php endif; ?>
                        </button>
                        <div class="topbar-bell-menu" id="bellMenu">
                            <div class="bell-menu-head">
                                <span class="bell-menu-title">Notifications</span>
                                <?php if($notifCount > 0): ?><span class="bell-menu-count"><?php echo e($notifCount); ?> new</span><?php endif; ?>
                            </div>
                            <div class="bell-menu-list">
                                <?php $__empty_1 = true; $__currentLoopData = $notifItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <a href="<?php echo e($n['url']); ?>" class="bell-item <?php echo e($n['unread'] ? 'unread' : ''); ?>">
                                        <span class="bell-item-ic bell-ic-<?php echo e($n['type']); ?>">
                                            <?php if($n['type'] === 'order'): ?>
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/></svg>
                                            <?php else: ?>
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                                        ...
                                        <span class="bell-item-body">
                                            <span class="bell-item-title"><?php echo e($n['title']); ?></span>
                                            <span class="bell-item-sub"><?php echo e($n['sub']); ?></span>
                                            <span class="bell-item-time"><?php echo e($n['time'] ? $n['time']->diffForHumans() : ''); ?></span>
                                        </span>
                                        <?php if($n['unread']): ?><span class="bell-item-dot"></span><?php endif; ?>
                                    </a>
                            ...
                            <a href="<?php echo e(route('admin.enquiries.index')); ?>" class="bell-menu-foot">View all enquiries</a>
                        </div>
                    </div>
                    <div class="topbar-user-wrap" id="userWrap">
                        <button type="button" class="topbar-user" onclick="toggleUserMenu()" aria-haspopup="true" aria-expanded="false" id="userToggle">
                            <span class="topbar-user-avatar"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                            <span class="topbar-user-meta">
                                <span class="topbar-user-name"><?php echo e(Auth::user()->name); ?></span>
                                <span class="topbar-user-role"><?php echo e(ucfirst(Auth::user()->role)); ?></span>
                            </span>
                        ...
                        <div class="topbar-user-menu" id="userMenu">
                            <div class="user-menu-head">
                                <span class="user-menu-avatar"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                                <span class="user-menu-id">
                                    <span class="user-menu-name"><?php echo e(Auth::user()->name); ?></span>
                                    <span class="user-menu-role"><?php echo e(ucfirst(Auth::user()->role)); ?></span>
                                </span>
                            </div>
                            <a href="<?php echo e(route('admin.settings.edit')); ?>" class="user-menu-item">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>
                                Settings
                            </a>
                            <form method="POST" action="<?php echo e(route('admin.logout')); ?>">
...
<?php /**PATH E:\Manikstu Website\backend\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>