        ...
        <PageHero>
          ...
          <div>
            ...
            <p className="mt-6 max-w-lg text-lg leading-relaxed text-grey">
              From veterinary support and breeding to farm-management software,
              insurance and farmer training — Manikstu delivers integrated
              services that make goat farming a viable, scalable livelihood.
            </p>
