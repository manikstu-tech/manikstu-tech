      ...
      <main id="main-content">
        ...
        <section className="relative bg-white overflow-hidden">
          ...
          <Image
            ...
            height={724}
            loading="eager"
            className="pointer-events-none select-none absolute bottom-16 left-0 w-[18%] max-w-none h-auto opacity-80 -scale-x-100"
          />
          ...
          <Image
            ...
            height={724}
            loading="eager"
            className="pointer-events-none select-none absolute bottom-16 right-0 w-[18%] max-w-none h-auto opacity-80"
          />
