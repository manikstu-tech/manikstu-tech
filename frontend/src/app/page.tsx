        ...
        <section className="relative overflow-hidden section-padding bg-manikstu-cream dark:bg-gray-900">
          ...
          <div aria-hidden className="pointer-events-none absolute left-0 top-[55%] -translate-y-1/2 select-none z-0">
            <Image
              ...
              width={320}
              height={576}
              className="h-auto w-32 sm:w-44 md:w-56 lg:w-72 max-h-[80%] object-contain object-left opacity-40 sm:opacity-50 dark:opacity-30"
            />
          </div>
          ...
          <div aria-hidden className="pointer-events-none absolute right-0 top-[55%] -translate-y-1/2 select-none z-0">
            <Image
              ...
              width={320}
              height={576}
              className="h-auto w-32 sm:w-44 md:w-56 lg:w-72 max-h-[80%] object-contain object-right opacity-40 sm:opacity-50 dark:opacity-30"
            />
          </div>
