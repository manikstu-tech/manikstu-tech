      ...
      <main id="main-content">
        ...
        <section className="relative section-padding bg-white overflow-hidden">
          ...
          <Image
            ...
            height={724}
            loading="eager"
            className="pointer-events-none select-none absolute bottom-[-40px] left-0 w-[45%] max-w-none h-auto opacity-70 -scale-x-100"
          />
          ...
          <Image
            ...
            height={724}
            loading="eager"
            className="pointer-events-none select-none absolute bottom-[-40px] right-0 w-[45%] max-w-none h-auto opacity-70"
          />
          <div className="relative mx-auto max-w-7xl">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              {/* Phone mockup */}
